...
#################################
### this code is based on newest scheme of sending one layer
#################################
...
for i_L, Nl in enumerate(Nl_list):
    ...
    B_orig_X = foliated_graph(Sx_mat,s_nodes, Nl, bdy, "odd")
    B_orig_Z = foliated_graph(Sz_mat,s_nodes, Nl, bdy, "even")
